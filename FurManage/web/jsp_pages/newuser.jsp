              ...
              <div id="back-of-jumbo">
                ...
                <p>Furry Hub and Community Manager</p><br><br>
                  ...
                  <form form method="post" action="../jsp_processes/recordnewuser.jsp">
                    ...
                    <!-- Username -->
                    <label for="usrname">Username (Must be Unique)</label><br>
                    <input type="text" name="usrname" class="form-control" id="usrname" minlength="4" value=""><br><br>

                    <!-- Password -->
                    <label for="psswd">Password</label><br>
                    <input type="password" name="psswd" class="form-control" id="psswd" minlength="6" maxlength="128" value=""><br><br>

                    <!-- Repeat Password -->
                    <label for="rpsswd">Repeat Password</label><br>
                    <input type="password" name="rpsswd" class="form-control" id="rpsswd" minlength="6" maxlength="128" value=""><br><br>
                    ...
                    var password = document.getElementById("psswd")
                      , confirm_password = document.getElementById("rpsswd");
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="fursuit" id="exampleRadios3" value=0 checked>
                    ...
                    <input type="text" name="avatar" class="form-control" id="avatar" value=""><br>
